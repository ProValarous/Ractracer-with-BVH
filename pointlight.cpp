...
bool dsRT::PointLight::ComputeIllumination(const qbVector<double> &intPoint, const qbVector<double> &localNormal, const std::vector<std::shared_ptr<dsRT::Object>> &objectList, const std::shared_ptr<dsRT::Object> &currentObject, qbVector<double> &color, double &intensity)
{
