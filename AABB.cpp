...
namespace aabb
{
        ...
        touchIsOverlap(touchIsOverlap_)
    {
        ...
        for (unsigned int i=0;i<dimension;i++)
        {
            ...
            negMinImage[i] = -0.5*boxSize[i]; //negative image multiplied by -0.5 because of
                                              //the image referring to negative x and y axis.
    ...
    void Tree::insertLeaf(unsigned int leaf)
    {
        ...
        // Find the best sibling for the node to be bounded together inside a sub-bounding box.
        ...
        // Walk back up the tree fixing heights and AABBs. Bottom-Up approach.
    ...
    //Balancing properties satisfied below. 
